...
function c(t2) {
  if (h) t2 = (a ||= new TextEncoder()).encode(t2);
  else {
    let n2 = 0;
...
function oe(t2) {
  ...
  return e2 || (Math.random() > 0.01 ? t2 : ((function(t3) {
    ...
    (ae ||= new ue()).set(t3, e3), (he ||= new ue()).set(e3, t3);
  })(t2, e2), e2));
}
var ae;
var he;
...
function _e(t2, e2, n2) {
  if (f && me()) {
    ...
    Ee(t2, n2) ? ((i2 = (r2 = fe ||= new ue()).get(e2)) || (i2 = new ue(), r2.set(e2, i2)), i2.set(t2, n2)) : (j(), Te(t2, e2));
  }
}
function ve(t2, e2) {
...
function je(t2, e2, n2 = st) {
  if (null != t2) {
    ...
    if (Array.isArray(t2)) {
      var r2 = tt(t2);
      return 2 & r2 ? t2 : (e2 &&= 0 === r2 || !!(32 & r2) && !(64 & r2 || !(16 & r2)), e2 ? (nt(t2, -12293 & (34 | r2)), t2) : De(t2, je, 4 & r2 ? st : n2, true, true));
    }
...
function Ye(t2, e2, n2, r2) {
  ...
  if (!(n2 >= i2)) {
    var s2 = t2.length;
    return r2 && 256 & e2 && null != (r2 = t2[s2 - 1][n2]) ? (Ke(t2, e2, i2, n2) && null != $ && ((e2 = (t2 = G ??= {})[$] || 0) >= 4 || (t2[$] = e2 + 1, j())), r2) : Ke(t2, e2, i2, n2);
  }
...
function gn(t2, e2, n2, r2, i2, s2, o2) {
  const a2 = t2.u;
  var h2 = !!(2 & e2);
  i2 = h2 ? 1 : i2, s2 = !!s2, o2 &&= !h2, h2 = nn(a2, e2, r2);
  var c2 = tt(h2), u2 = h2;
    ...
    if (c2) {
      ...
      if (r2) {
        t: {
          ...
          if (o2) for (let t3 in o2) isNaN(+t3) ? (s2 ??= {})[t3] = o2[t3] : (r2 = o2[t3], Array.isArray(r2) && (ft(r2) || ct(r2) && 0 === r2.size) && (r2 = null), null == r2 && (a2 = true), null != r2 && ((s2 ??= {})[t3] = r2));
...
function ir(t2) {
  return t2 ? /^\d+$/.test(t2) ? (Vt(t2), new sr(Pt, Ot)) : null : or ||= new sr(0, 0);
}
...
var or;
function ar(t2) {
  return t2 ? /^-?\d+$/.test(t2) ? (Vt(t2), new hr(Pt, Ot)) : null : cr ||= new hr(0, 0);
}
var hr = class {
  constructor(t2, e2) {
    this.h = t2 >>> 0, this.g = e2 >>> 0;
  ...
  if (!e2) {
    ...
    e2 = r2 ? (t3, e3) => r2(t3, e3, n2) : (t3, e3) => {
      for (; Kn(e3) && 4 != e3.h; ) {
        ...
        o2 && o2(e3, t3, r3) || (r3 = (i2 = e3).l, Yn(i2), i2.ja ? i2 = void 0 : (s2 = i2.g.g - r3, i2.g.g = r3, i2 = Wn(i2.g, s2)), r3 = t3, i2 && (mt ||= Symbol(), (s2 = r3[mt]) ? s2.push(i2) : r3[mt] = [i2])), a2 && o2 && !h2 && Wr++ < 5 && j();
      }
    }, t2[Ar] = e2;
  }
  return e2;
...
function Ir(t2, e2) {
  let n2, r2;
  const i2 = t2.h;
  return (t3, s2, o2) => i2(t3, s2, o2, r2 ||= Pr(e2).g, n2 ||= Rr(e2));
}
function Pr(t2) {
  let e2 = t2[Fr];
...
function Nr(t2, e2, n2) {
  const r2 = t2.g;
  let i2, s2;
  return (t3, o2, a2) => r2(t3, o2, a2, s2 ||= Ur(e2).g, i2 ||= br(e2), n2);
}
function Ur(t2) {
  let e2 = t2[Or];
...
var ti = Gr((function(t2, e2, n2) {
  ...
  null != (e2 = Ht(e2)) && (gr(t2, n2, 1), t2 = t2.g, (n2 = It ||= new DataView(new ArrayBuffer(8))).setFloat64(0, +e2, true), Pt = n2.getUint32(0, true), Ot = n2.getUint32(4, true), dr(t2, Pt), dr(t2, Ot));
}));
...
//# sourceMappingURL=vision_bundle-BPTYIADO.js.map
